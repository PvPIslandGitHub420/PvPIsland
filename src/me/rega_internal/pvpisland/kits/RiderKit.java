...
public class RiderKit implements Kit
{
	...
	{
		return new String[] { "Ride your mighty steed into war!" };
	}

	public ItemStack[] getItems()
	{
		ItemStack sword = new Item(new ItemStack(Material.DIAMOND_SWORD)).setName("&fSword").build();
