...
public class HermitKit implements Kit
{
	...
	{
		return new String[] { "Hide in a box." };
	}
	...
	public ItemStack[] getItems()
	{
		...
		ItemStack dirt = new Item(new ItemStack(Material.DIRT)).setName("&fDirt Structure").build();
		...
		return new ItemStack[] { sword, dirt, gapple, steak };
	}
